...
class AppColors {
  ...
  // === BASE COLORS (sesuai design) ===
  static const Color darkSlate = Color(0xFF2F3640); 
  static const Color deepPurple = Color(0xFF6C5CE7); 
  static const Color vividOrange = Color(0xFFFF7675); 
  static const Color softMint = Color(0xFF55E6C1); 
  ...
  // === ACCENT ===
  static const Color eventAccent = softMint;
